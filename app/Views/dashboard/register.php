            ...
            <div class="register-body">
                <form action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="instansi" placeholder="Masukkan Instansi">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" style="border-right: none;" id="confirm-password" placeholder="Masukkan Konfirmasi Password">
                            <span class="d-flex align-items-center p-2 show-password"><i class="fas fa-eye-slash" onclick="showPassword(this)"></i></span>
                        </div>
                    </div>
                    <div class="mt-5">
