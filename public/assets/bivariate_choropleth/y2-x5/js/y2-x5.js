...
}).fitBounds([[-7.1259269980774,106.85800061122343],[-6.376429535727361,108.26783598649898]]);
...
function style_bb_pwk_TanpaBatasKec_0_0() {
    return {
        pane: 'pane_bb_pwk_TanpaBatasKec_0',
        opacity: 1,
...
map.createPane('pane_bb_pwk_TanpaBatasKec_0');
map.getPane('pane_bb_pwk_TanpaBatasKec_0').style.zIndex = 400;
map.getPane('pane_bb_pwk_TanpaBatasKec_0').style['mix-blend-mode'] = 'normal';
...
function pop_Kbb_Pwk_1(feature, layer) {
    ...
    var popupContent = '<table>\
            ...
            <tr>\
                <td colspan="2">Kategori : ' + (feature.properties['Biv_new'] !== null ? autolinker.link(feature.properties['Biv_new'].toLocaleString()) : '') + '</td>\
            </tr>\
            <tr>\
                <td colspan="2">Jumlah Fasilitas Pendidikan 2021 : ' + (feature.properties['Y2X5_X5_Alternatif'] !== null ? autolinker.link(feature.properties['Y2X5_X5_Alternatif'].toLocaleString()) : '') + '</td>\
            </tr>\
            <tr>\
                <td colspan="2">Laju Perubahan Lahan Sawah Tahunan : ' + (feature.properties['Y2X5_Y2'] !== null ? autolinker.link(feature.properties['Y2X5_Y2'].toLocaleString()) : '') + '</td>\
            </tr>\
        </table>';
    layer.bindPopup(popupContent, {maxHeight: 400});
}
...
function style_Kbb_Pwk_1_0(feature) {
    switch(String(feature.properties['Biv_new'])) {
        case 'Low Low':
            return {
        pane: 'pane_Kbb_Pwk_1',
        opacity: 1,
...
map.createPane('pane_Kbb_Pwk_1');
map.getPane('pane_Kbb_Pwk_1').style.zIndex = 401;
map.getPane('pane_Kbb_Pwk_1').style['mix-blend-mode'] = 'multiply';
...
legend.onAdd = function (map) {
    ...
    div.innerHTML =
    '<img src="/assets/bivariate_choropleth/y2-x5/LegendX5.png" alt="" width="200" height="200">'
